...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('stablemanager_pilotweek', (
            ...
            ('wounds', self.gf('django.db.models.fields.IntegerField')()),
        ))
        ...
        db.add_column('stablemanager_pilottraining', 'pilot_week',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['stablemanager.PilotWeek']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'PilotTraining.pilot'
        raise RuntimeError("Cannot reverse this migration. 'PilotTraining.pilot' and its values cannot be restored.")
