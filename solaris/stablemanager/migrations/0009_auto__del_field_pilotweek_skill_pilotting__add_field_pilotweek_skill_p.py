...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PilotWeek.skill_pilotting'
        db.delete_column(u'stablemanager_pilotweek', 'skill_pilotting')

        # Adding field 'PilotWeek.skill_piloting'
        db.add_column('stablemanager_pilotweek', 'skill_piloting',
                      self.gf('django.db.models.fields.IntegerField')(default=5),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PilotWeek.skill_pilotting'
        db.add_column(u'stablemanager_pilotweek', 'skill_pilotting',
                      self.gf('django.db.models.fields.IntegerField')(default=5),
                      keep_default=False)

        # Deleting field 'PilotWeek.skill_piloting'
        db.delete_column('stablemanager_pilotweek', 'skill_piloting')
    ...
    models = {
        ...
        'stablemanager.pilotweek': {
            ...
            'skill_piloting': ('django.db.models.fields.IntegerField', [], {}),
