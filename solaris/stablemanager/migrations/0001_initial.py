...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Stable'
        db.create_table('stablemanager_stable', (
        ...
        db.send_create_signal('stablemanager', ['Stable'])
        ...
        db.create_table('stablemanager_pilot', (
            ...
            ('pilot_rank', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('skill_gunnery', self.gf('django.db.models.fields.IntegerField')()),
            ('skill_pilotting', self.gf('django.db.models.fields.IntegerField')()),
            ('exp_character_points', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('exp_wounds', self.gf('django.db.models.fields.IntegerField')()),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('stablemanager_stable')
