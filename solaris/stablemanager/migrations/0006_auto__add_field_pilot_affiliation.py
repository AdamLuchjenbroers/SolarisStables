...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pilot.affiliation'
        db.add_column('stablemanager_pilot', 'affiliation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['warbook.House']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pilot.affiliation'
        db.delete_column('stablemanager_pilot', 'affiliation_id')
