...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'stablemanager_pilotrank')


        # Changing field 'Pilot.pilot_rank'
        db.alter_column('stablemanager_pilot', 'pilot_rank_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['warbook.PilotRank']))

    def backwards(self, orm):
        # Adding model 'PilotRank'
        db.create_table(u'stablemanager_pilotrank', (
            ('skills_limit', self.gf('django.db.models.fields.IntegerField')()),
            ('rank', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True)),
        ...
        # Changing field 'Pilot.pilot_rank'
        db.alter_column('stablemanager_pilot', 'pilot_rank_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stablemanager.PilotRank']))
    ...
    models = {
        ...
        'stablemanager.pilot': {
            ...
            'pilot_rank': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['warbook.PilotRank']"}),
