...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LedgerItem.tied'
        db.add_column('stablemanager_ledgeritem', 'tied',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LedgerItem.tied'
        db.delete_column('stablemanager_ledgeritem', 'tied')
    ...
    models = {
        ...
        'stablemanager.ledger': {
            ...
            'stable': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['stablemanager.Stable']"}),
