...
class TestAddPilotForm(StableTestMixin, TestCase):
    def setUp(self):
        ...
        self.url = reverse('stable_add_pilot', kwargs={'week' : 1})
    ...
    def test_add_pilot_response(self):
        ...
        self.assertEqual(response.status_code, 201, 'Add Pilot Form returned incorrect status code (HTTP %s)' % response.status_code)
