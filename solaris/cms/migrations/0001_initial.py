...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cms_staticcontent', (
            ...
            ('toplevel', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('order', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('cms', ['StaticContent'])

        # Adding model 'NewsPost'
        db.create_table('cms_newspost', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('cms', ['NewsPost'])


    def backwards(self, orm):
        # Deleting model 'StaticContent'
        db.delete_table('cms_staticcontent')

        # Deleting model 'NewsPost'
        db.delete_table('cms_newspost')
    ...
    models = {
        ...
        'cms.staticcontent': {
            ...
            'toplevel': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
