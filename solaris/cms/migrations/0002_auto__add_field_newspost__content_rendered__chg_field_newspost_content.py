...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsPost._content_rendered'
        db.add_column(u'cms_newspost', '_content_rendered',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'NewsPost.content'
        db.alter_column(u'cms_newspost', 'content', self.gf('markitup.fields.MarkupField')(no_rendered_field=True))

    def backwards(self, orm):
        # Deleting field 'NewsPost._content_rendered'
        db.delete_column(u'cms_newspost', '_content_rendered')


        # Changing field 'NewsPost.content'
        db.alter_column(u'cms_newspost', 'content', self.gf('django.db.models.fields.TextField')())
