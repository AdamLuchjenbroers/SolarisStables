...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'MechDesign', fields ['ssw_filename']
        db.create_unique('warbook_mechdesign', ['ssw_filename'])


        # Changing field 'MechDesign.mech_code'
        db.alter_column('warbook_mechdesign', 'mech_code', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'MechDesign.mech_name'
        db.alter_column('warbook_mechdesign', 'mech_name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):
        # Removing unique constraint on 'MechDesign', fields ['ssw_filename']
        db.delete_unique('warbook_mechdesign', ['ssw_filename'])
    ...
    models = {
        ...
        'warbook.mechdesign': {
            ...
            'ssw_filename': ('django.db.models.fields.CharField', [], {'max_length': '255', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
