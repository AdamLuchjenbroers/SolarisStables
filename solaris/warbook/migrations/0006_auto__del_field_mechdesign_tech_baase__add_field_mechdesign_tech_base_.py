...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Equipment.record_status'
        db.add_column('warbook_equipment', 'record_status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Equipment.record_status'
        db.delete_column('warbook_equipment', 'record_status')
