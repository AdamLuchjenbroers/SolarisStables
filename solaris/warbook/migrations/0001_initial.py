...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('warbook_mechdesign', (
            ...
            ('omni_loadout', self.gf('django.db.models.fields.CharField')(default='N/A', max_length=30, blank=True)),
            ...
            ('omni_basechassis', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['warbook.MechDesign'], null=True, blank=True)),
