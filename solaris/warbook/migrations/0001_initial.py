...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
       ...
       # Adding unique constraint on 'TrainingCost', fields ['training', 'train_to']
        ...
        db.create_table('warbook_pilottraitgroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.create_table('warbook_pilottrait', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=40)),
        ...
        m2m_table_name = db.shorten_name('warbook_house_x_discipline')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('house', models.ForeignKey(orm['warbook.house'], null=False)),
            ('pilottraitgroup', models.ForeignKey(orm['warbook.pilottraitgroup'], null=False))
        ))
        db.create_unique(m2m_table_name, ['house_id', 'pilottraitgroup_id'])
        ...
        db.create_table('warbook_technologyrollmodifier', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('technology', self.gf('django.db.models.fields.related.ForeignKey')(related_name='modifiers', to=orm['warbook.Technology'])),
        ...
        db.send_create_signal('warbook', ['TechnologyRollModifier'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('warbook_pilottraitgroup')

        # Deleting model 'PilotTrait'
        db.delete_table('warbook_pilottrait')

        # Deleting model 'House'
        db.delete_table('warbook_house')

        # Removing M2M table for field house_disciplines on 'House'
        db.delete_table(db.shorten_name('warbook_house_x_discipline'))
    ...
    models = {
        ...
        'warbook.pilottraitgroup': {
            'Meta': {'object_name': 'PilotTraitGroup'},
            'blurb': ('django.db.models.fields.TextField', [], {}),
        ...
        'warbook.technologyrollmodifier': {
            'Meta': {'object_name': 'TechnologyRollModifier'},
            'condition': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifier': ('django.db.models.fields.IntegerField', [], {'default': '2'}),
            'technology': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'modifiers'", 'to': "orm['warbook.Technology']"})
        },
