...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'warbook_pilotdiscipline', (
            ('urlname', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True)),
        ...
        db.alter_column('warbook_pilotability', 'discipline_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['warbook.PilotDiscipline']))
