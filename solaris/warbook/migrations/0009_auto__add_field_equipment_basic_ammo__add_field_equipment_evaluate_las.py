...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Equipment.basic_ammo'
        db.add_column('warbook_equipment', 'basic_ammo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Equipment.evaluate_last'
        db.add_column('warbook_equipment', 'evaluate_last',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Equipment.basic_ammo'
        db.delete_column('warbook_equipment', 'basic_ammo')

        # Deleting field 'Equipment.evaluate_last'
        db.delete_column('warbook_equipment', 'evaluate_last')
