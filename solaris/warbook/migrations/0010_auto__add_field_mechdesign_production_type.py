...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MechDesign.production_type'
        db.add_column('warbook_mechdesign', 'production_type',
                      self.gf('django.db.models.fields.CharField')(default='P', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MechDesign.production_type'
        db.delete_column('warbook_mechdesign', 'production_type')
