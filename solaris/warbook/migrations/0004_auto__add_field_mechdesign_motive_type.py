...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MechDesign.motive_type'
        db.add_column('warbook_mechdesign', 'motive_type',
                      self.gf('django.db.models.fields.CharField')(default='B', max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MechDesign.motive_type'
        db.delete_column('warbook_mechdesign', 'motive_type')
    ...
    models = {
        ...
        'warbook.mechdesign': {
            ...
            'motive_type': ('django.db.models.fields.CharField', [], {'max_length': '8'}),
