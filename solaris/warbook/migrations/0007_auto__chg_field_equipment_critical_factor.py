...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Equipment.critical_factor'
        db.alter_column('warbook_equipment', 'critical_factor', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Equipment.critical_factor'
        db.alter_column('warbook_equipment', 'critical_factor', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=1))
