...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Equipment.tonnage_factor'
        db.alter_column('warbook_equipment', 'tonnage_factor', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

        # Changing field 'Equipment.cost_factor'
        db.alter_column('warbook_equipment', 'cost_factor', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=4))

    def backwards(self, orm):

        # Changing field 'Equipment.tonnage_factor'
        db.alter_column('warbook_equipment', 'tonnage_factor', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=1))

        # Changing field 'Equipment.cost_factor'
        db.alter_column('warbook_equipment', 'cost_factor', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=1))
