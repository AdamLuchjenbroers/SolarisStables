...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('warbook_mechdesign', 'motive_type', self.gf('django.db.models.fields.CharField')(max_length=1))

    def backwards(self, orm):
        # Changing field 'MechDesign.motive_type'
        db.alter_column('warbook_mechdesign', 'motive_type', self.gf('django.db.models.fields.CharField')(max_length=8))
    ...
    models = {
        ...
        'warbook.mechdesign': {
            ...
            'tech_baase': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
